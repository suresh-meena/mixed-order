...
# Make running this script directly (python experiments/.../plot.py)
# work by ensuring the repository root is on sys.path so imports like
# `from experiments...` resolve correctly.
import sys
import pathlib
